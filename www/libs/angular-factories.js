...
/*
.factory("AnnotationOptions", [
    '$location', '$routeParams', 'EventAnnoTypesService', 
    function($location, $routeParams, EventAnnoTypesService) {
    ...
    var AnnotationOptions = function(scope) {
        ...
        function initialize() {
            ...
            EventAnnoTypesService.listTypes(function(rslt) {
