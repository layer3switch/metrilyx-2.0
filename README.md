...
#### Getting Started
To quickly get up and running, follow the  [Installation Guide](https://github.com/Ticketmaster/metrilyx-2.0/blob/master/docs/Installation.rst "Installation Guide").
